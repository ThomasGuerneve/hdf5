...
polly_init(
    "RaspberryPi 3 / 32 bits / Cross Compile"
    "Unix Makefiles"
)
...
if(_is_empty)
  set(_rpi_error_msg
      "${_rpi_error_msg}\nARMHF_CROSS_COMPILE_TOOLCHAIN_PREFIX environment variable not set. Set it to the triplet of the toolchain (ex: arm-linux-gnueabihf)"
  )
endif()
...
set(RASPBERRYPI3_COMPILE_FLAGS
    "-mcpu=cortex-a53 -mtune=cortex-a53 -mfpu=neon-fp-armv8 -mfloat-abi=hard"
    CACHE STRING "RaspberryPi 3 32 bits Compile Flags"
)
